	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-12">
				<div class="table-responsive container-fluid">
					<table
						...
						<tr>
							<td colspan="5">공격수 1, 수비수 1 구합니다</td>
						</tr>
					</table>
				</div>
			</div>
			...
			<div class="col-sm-12 col-md-12 enter-row-1">
				<a href="/recruit/recruit_loan_list"><button type="button" class="btn btn-default col-md-2 pull-left">목록</button></a>
			...
			<div class="col-sm-12 col-md-12 enter-row-1">
				<button type="button" data-toggle="modal" data-target="#reqeustJoin"  class="btn btn-success btn-block ">용병 신청</button>
			</div>
						...
						<form>
							...
							<div class="form-group">
								<label for="date">경기 날짜</label> <input type="date"
									class="form-control" id="date" name="date" value="2019-12-25">
							</div>
							<div class="form-group">
								<label for="time">경기 시간</label> <input type="time"
									class="form-control" id="time" name="time" value="16:53">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="message">메시지</label> <textarea
									class="form-control" id="message" name="message" rows="3" cols="20" placeholder="공격수 1, 수비수 1 구합니다"></textarea>
							</div>
						</form>
					</div>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="gridSystemModalLabel">용병 신청</h4>
				</div>
				<div class="modal-body">
					<div class="container-fluid">
						<form>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
					<button type="button" class="btn btn-primary" id="doRequestJoin">용병 신청</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="gridSystemModalLabel">용병 요청 수락</h4>
				</div>
				<div class="modal-body">
					<div class="container-fluid text-center">
						<h2>정말 수락하시겠습니까?</h2>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="gridSystemModalLabel">용병 신청내용 수정</h4>
				</div>
				<div class="modal-body">
					<div class="container-fluid">
						<form>
